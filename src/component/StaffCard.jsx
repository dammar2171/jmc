...
import puneet from "../assets/puneetsir.jpg";
import dilli from "../assets/dillisir.jpg";
import principle from "../assets/principleSir.jpg";
import dharmananda from "../assets/dharmanandsir.jpg";
import surendra from "../assets/surendrasir.jpg";
import umesh from "../assets/umeshsir.jpg";
import bharat from "../assets/bharatsir.jpg";
import yagya from "../assets/yagyasir.jpg";
const StaffCard = () => {
  const staffData = [
    {
      id: 1,
  ...
  return (
    <div className="container-fluid py-5">
      <div className="container">
        ...
        <h1 className="pb-5" style={{ color: "#0a4a85" }}>
